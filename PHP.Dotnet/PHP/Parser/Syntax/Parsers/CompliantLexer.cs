...
namespace Devsense.PHP.Syntax
{
    ...
    /// </summary>
    internal class CompliantLexer : IParserTokenProvider<SemanticValueType, Span2>
    {
        ITokenProvider<SemanticValueType, Span2> _provider;
        ...
        public CompliantLexer(ITokenProvider<SemanticValueType, Span2> provider)
        {
            _provider = provider;
        }
        ...
        public Span2 TokenPosition => _provider.TokenPosition;
