...
namespace Devsense.PHP.Syntax
{
    ...
    public struct CompleteToken
    {
        ...
        /// Token span.
        /// </summary>
        public readonly Span2 TokenPosition;
        ...
        /// </summary>
        public static readonly CompleteToken Empty = new CompleteToken(Tokens.T_ERROR, new SemanticValueType(), Span2.Invalid, string.Empty);
        ...
        public CompleteToken(Tokens token, SemanticValueType tokenValue, Span2 tokenPosition, string tokenText)
        {
            Token = token;
