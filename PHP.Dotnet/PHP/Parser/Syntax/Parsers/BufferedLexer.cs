...
namespace Devsense.PHP.Syntax
{
    ...
    internal sealed class BufferedLexer : IParserTokenProvider<SemanticValueType, Span2>
    {
        private IParserTokenProvider<SemanticValueType, Span2> _provider;
        ...
        public BufferedLexer(IParserTokenProvider<SemanticValueType, Span2> provider)
        {
            _provider = provider;
        }
        ...
        public Span2 TokenPosition => _buffer.Count > 0 ? _buffer.Peek().TokenPosition : _provider.TokenPosition;
