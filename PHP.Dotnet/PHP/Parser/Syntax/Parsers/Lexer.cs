...
namespace Devsense.PHP.Syntax
{
    ...
    /// </summary>
    public partial class Lexer : ITokenProvider<SemanticValueType, Span2>, IDisposable
    {
        /// <summary>
        ...
        void SetDocBlock() => DocBlock = new PHPDocBlock(GetTokenString(intern: false), new Span2(_charOffset, this.TokenLength));    // TokenPosition is not updated yet at this point
        ...
        public void UpdateTokenPosition()
        {
            ...
            _tokenPosition = new Span2(_charOffset, tokenLength);
            _charOffset += tokenLength;
            _tokenText = null;
        }

        void ITokenProvider<SemanticValueType, Span2>.ReportError(string[] expectedTerminals)
        {
        ...
        int ITokenProvider<SemanticValueType, Span2>.GetNextToken() => (int)GetNextToken();
        ...
        protected double GetTokenAsDouble(int startIndex)
        {
            ...
            {
                _errors.Error(new Span2(_charOffset, this.TokenLength), Warnings.TooBigDouble, GetTokenString());
        ...
        /// </summary>
        public Span2 TokenSpan => TokenPosition;

        /// <summary>
        /// Alias to <see cref="TokenSpan"/>.
        /// </summary>
        public Span2 TokenPosition => _tokenPosition;
