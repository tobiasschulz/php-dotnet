...
namespace Devsense.PHP.Syntax
{
    class LexerState : ILexerState
    {
        ...
        public LexerState(int state, Dictionary<int, int> expectedTokens, CompleteToken previousToken, CompleteToken currentToken, IParserTokenProvider<SemanticValueType, Span2> provider)
        {
            CurrentState = state;
