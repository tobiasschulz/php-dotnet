...
namespace Devsense.PHP.Syntax
{
    ...
    internal class PhpStringBuilder
    {
        ...
        public PhpStringBuilder(Encoding/*!*/encoding, string/*!*/value, Span2 span)
        ...
        private void Append(Span2 span)
        {
            if (this.span.IsValid)
            {
                if (span.IsValid)
                    this.span = Span2.Combine(this.span, span);
            }
            else
            {
                this.span = span;
        ...
        public void Append(string str, Span2 span)
        {
            Append(span);
            Append(str);
        }
        ...
        public void Append(char c, Span2 span)
        {
            Append(span);
            Append(c);
        }
        ...
        public void Append(byte b, Span2 span)
        {
            Append(span);
            Append(b);
        }
