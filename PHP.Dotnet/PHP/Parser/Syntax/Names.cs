...
namespace Devsense.PHP.Syntax
{
    ...
    public struct TranslatedQualifiedName
    {
        ...
        /// </summary>
        public Span2 Span => _name.Span;

        public TranslatedQualifiedName(QualifiedName name, Span2 nameSpan, QualifiedName originalName, QualifiedName? nameFallback)
        {
        ...
        public TranslatedQualifiedName(QualifiedName name, Span2 nameSpan) : this(name, nameSpan, name, null) { }
    }
