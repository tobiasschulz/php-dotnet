...
namespace Devsense.PHP.Syntax
{
    ...
    public abstract class SourceUnit : ILineBreaks, IPropertyCollection
    {
        ...
        public abstract void Parse(INodesFactory<LangElement, Span2> factory, Errors.IErrorSink<Span2> errors, Errors.IErrorRecovery recovery = null);

        public abstract void Close();

        public abstract string GetSourceCode(Span2 span);
    ...
    public class CodeSourceUnit : SourceUnit
    {
        ...
        public override void Parse(INodesFactory<LangElement, Span2> factory, Errors.IErrorSink<Span2> errors, Errors.IErrorRecovery recovery = null)
        {
        ...
        {
            this.ast = new GlobalCode(new Span2(), new List<Statement>(), this);
        }

        public override string GetSourceCode(Span2 span)
        {
        ...
        public static SourceUnit/*!*/ParseCode(string code, string filePath,
            INodesFactory<LangElement, Span2> factory = null,
            Errors.IErrorSink<Span2> errors = null,
            ...
            Lexer.LexicalStates initialState = Lexer.LexicalStates.INITIAL)
        {
            ...
            if (errors == null)
            {
                errors = (factory as Errors.IErrorSink<Span2>) ?? new EmptyErrorSink<Span2>();
            }
