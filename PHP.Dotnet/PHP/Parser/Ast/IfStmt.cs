...
namespace Devsense.PHP.Syntax.Ast
{
	...
	public sealed class IfStmt : Statement
	{
		...
		public IfStmt(Text.Span2 span, List<ConditionalStmt>/*!!*/ conditions)
			: base(span)
		{
	...
	public sealed class ConditionalStmt : AstNode
	{
        ...
        /// </summary>
        public readonly Text.Span2 Span;

        public ConditionalStmt(Text.Span2 span, Expression condition, Statement/*!*/ statement)
		{
            this.Span = span;
