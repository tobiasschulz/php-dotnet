...
namespace Devsense.PHP.Syntax.Ast
{
    ...
    public sealed class FormalTypeParam : LangElement
    {
        ...
        public FormalTypeParam(Text.Span2 span, Name name, object defaultType)
            : base(span)
        {
    ...
    public abstract class TypeDecl : Statement
    {
        ...
        public Text.Span2 HeadingSpan { get { return headingSpan; } }
        private Text.Span2 headingSpan;

        public Text.Span2 BodySpan { get { return bodySpan; } }
        private Text.Span2 bodySpan;
        ...
        public TypeDecl(
            Text.Span2 span, Text.Span2 headingSpan,
            ...
            IList<INamedTypeRef>/*!*/ implementsList, IList<TypeMemberDecl>/*!*/ elements, Text.Span2 bodySpan)
            : base(span)
        {
    ...
    public sealed class NamedTypeDecl : TypeDecl
    {
        ...
        public NamedTypeDecl(
            Text.Span2 span, Text.Span2 headingSpan, bool isConditional, PhpMemberAttributes memberAttributes, bool isPartial,
    ...
    public sealed class AnonymousTypeDecl : TypeDecl
    {
        ...
        /// </summary>
        public override NameRef Name => new NameRef(Text.Span2.Invalid, GeneratePhpLikeName(this.ContainingSourceUnit, this.Span));
        ...
        private static string GeneratePhpLikeName(SourceUnit unit, Text.Span2 span)
        {
            // see zend_compile.c
    ...
    public abstract class TypeMemberDecl : LangElement
    {
        ...
        protected TypeMemberDecl(Text.Span2 span, PhpMemberAttributes modifiers)
            : base(span)
        {
    ...
    public sealed class MethodDecl : TypeMemberDecl
    {
        ...
        /// </summary>
        public Text.Span2 ParametersSpan { get { return Signature.Span; } }

        /// <summary>
        /// Span of the entire method header.
        /// </summary>
        public Text.Span2 HeadingSpan
        {
            get
            {
                if (Span.IsValid)
                {
                    ...
                    if (endspan.IsValid)
                    {
                        return Text.Span2.FromBounds(Span.Start, endspan.End);
                    }
                }

                //
                return Text.Span2.Invalid;
            }
        }
        ...
        public MethodDecl(Text.Span2 span,
            NameRef name, bool aliasReturn, IList<FormalParam>/*!*/ formalParams, Text.Span2 paramsSpan,
    ...
    public sealed class FieldDeclList : TypeMemberDecl
    {
        ...
        public FieldDeclList(Text.Span2 span, PhpMemberAttributes modifiers, IList<FieldDecl>/*!*/ fields)
            : base(span, modifiers)
        {
    ...
    public sealed class FieldDecl : LangElement
    {
        ...
        /// </summary>
        public Text.Span2 NameSpan => new Text.Span2(Span.Start, name.Value.Length + 1);
        ...
        public FieldDecl(Text.Span2 span, string/*!*/ name, Expression initVal)
            : base(span)
        {
    ...
    public sealed class ConstDeclList : TypeMemberDecl
    {
        ...
        public ConstDeclList(Text.Span2 span, PhpMemberAttributes modifiers, IList<ClassConstantDecl>/*!*/ constants)
            : base(span, modifiers)
        {
    ...
    {
        public ClassConstantDecl(Text.Span2 span, string/*!*/ name, Text.Span2 namePos, Expression/*!*/ initializer)
    ...
    public sealed class TraitAdaptationBlock : LangElement
    {
        ...
        public TraitAdaptationBlock(Text.Span2 span, IList<TraitsUse.TraitAdaptation>/*!*/body)
            : base(span)
        {
    ...
    public sealed class TraitsUse : TypeMemberDecl
    {
        ...
        public abstract class TraitAdaptation : LangElement
        {
            ...
            public TraitAdaptation(Text.Span2 span, Tuple<TypeRef, NameRef> traitMemberName)
                : base(span)
            {
        ...
        public sealed class TraitAdaptationPrecedence : TraitAdaptation
        {
            ...
            public TraitAdaptationPrecedence(Text.Span2 span, Tuple<TypeRef, NameRef> traitMemberName, IList<TypeRef>/*!*/ignoredTypes)
        ...
        public sealed class TraitAdaptationAlias : TraitAdaptation
        {
            ...
            public TraitAdaptationAlias(Text.Span2 span, Tuple<TypeRef, NameRef>/*!*/oldname, NameRef newname, PhpMemberAttributes? newmodifier)
                : base(span, oldname)
            {
                if (oldname == null)
        ...
        public TraitsUse(Text.Span2 span, IList<TypeRef>/*!*/traitsList, TraitAdaptationBlock traitAdaptationBlock)
