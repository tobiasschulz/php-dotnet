...
namespace Devsense.PHP.Syntax.Ast
{
    ...
    public sealed class ArrayEx : VarLikeConstructUse, IArrayExpression
    {
        ...
        public static ArrayEx CreateArray(Text.Span2 span, IList<Item>/*!*/items, bool isShortSyntax)
            => new ArrayEx(span, items, Flags.Array | (isShortSyntax ? Flags.ShortSyntax : 0));

        public static ArrayEx CreateList(Text.Span2 span, IList<Item>/*!*/items, bool isShortSyntax)
            => new ArrayEx(span, items, Flags.List | (isShortSyntax ? Flags.ShortSyntax : 0));

        private ArrayEx(Text.Span2 span, IList<Item> items, Flags flags)
            : base(span)
        {
