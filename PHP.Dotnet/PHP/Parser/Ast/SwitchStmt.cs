...
namespace Devsense.PHP.Syntax.Ast
{
	...
	public sealed class SwitchStmt : Statement
	{
		...
		public SwitchStmt(Text.Span2 span, Expression/*!*/ switchValue, IList<SwitchItem>/*!*/ switchItems)
			: base(span)
		{
    ...
    public abstract class SwitchItem : LangElement
	{
		...
		protected SwitchItem(Text.Span2 span, IList<Statement>/*!*/ statements)
			: base(span)
		{
    ...
    public sealed class CaseItem : SwitchItem
	{
		...
		public CaseItem(Text.Span2 span, Expression/*!*/ caseVal, IList<Statement>/*!*/ statements)
	...
	{
		public DefaultItem(Text.Span2 span, IList<Statement>/*!*/ statements)
			: base(span, statements)
		{
		}
