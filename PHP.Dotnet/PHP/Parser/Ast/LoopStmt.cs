...
namespace Devsense.PHP.Syntax.Ast
{
    ...
    public sealed class WhileStmt : Statement
    {
        ...
        /// </summary>
        public Text.Span2 ConditionPosition { get { return _conditionPosition; } }
        private Text.Span2 _conditionPosition;
        ...
        public WhileStmt(Text.Span2 span, Type type, Expression/*!*/ condExpr, Text.Span2 conditionSpan, Statement/*!*/ body)
            : base(span)
        {
    ...
    public sealed class ForStmt : Statement
    {
        ...
        /// Position of the header parentheses.
        /// </summary>
        public Text.Span2 ConditionSpan { get { return _conditionSpan; } }
        private Text.Span2 _conditionSpan;

        public ForStmt(Text.Span2 p,
            IList<Expression>/*!*/ initExList, IList<Expression>/*!*/ condExList, IList<Expression>/*!*/ actionExList,
            Text.Span2 conditionSpan, Statement/*!*/ body)
            : base(p)
        {
    ...
    public sealed class ForeachVar : AstNode
    {
        ...
        /// </summary>
        public Text.Span2 Span => _target.Span;
    ...
    public class ForeachStmt : Statement
    {
        ...
        public ForeachStmt(Text.Span2 span, Expression/*!*/ enumeree, ForeachVar key, ForeachVar/*!*/ value, Statement/*!*/ body)
            : base(span)
        {
