...
namespace Devsense.PHP.Syntax.Ast
{
	...
	public sealed class IncludingEx : Expression
	{
		...
		public IncludingEx(bool isConditional, Text.Span2 span,
	...
	public sealed class IssetEx : Expression
	{
		...
		public IssetEx(Text.Span2 span, IList<VariableUse>/*!*/ varList)
			: base(span)
		{
	...
	public sealed class EmptyEx : Expression
	{
        ...
        public EmptyEx(Text.Span2 p, Expression expression)
			: base(p)
		{
            if (expression == null)
	...
	public sealed class EvalEx : Expression
	{
		...
		public EvalEx(Text.Span2 span, Expression/*!*/ code)
            : base(span)
		{
            this.code = code;
		}
    ...
    public sealed class AssertEx : Expression
    {
        ...
        public AssertEx(Text.Span2 span, CallSignature callsignature)
            : base(span)
        {
	...
	public sealed class ExitEx : Expression
	{
		...
		public ExitEx(Text.Span2 span, Expression resultExpr)
            : base(span)
		{
