...
namespace Devsense.PHP.Syntax.Ast
{
    ...
    public interface INodesFactory<TNode, TSpan>
    {
        ...
        TNode Global(Span2 span, List<TNode> variables);
        ...
        TNode Unset(Span2 span, IEnumerable<TNode> variables);
        ...
        TNode Finally(Span2 span, TNode block);
        ...
        TNode Throw(Span2 span, TNode expression);
        ...
        TNode Case(Span2 span, TNode valueOpt, TNode block);
        ...
        ActualParam ActualParameter(Span2 span, TNode expr, ActualParam.Flags flags);
