...
namespace Devsense.PHP.Syntax.Ast
{
    ...
    public abstract class TypeRef : LangElement
    {
        ...
        internal static TypeRef FromGenericQualifiedName(Span2 span, GenericQualifiedName qname)
        {
            var tref = new ClassTypeRef(span, qname.QualifiedName);
            if (qname.IsGeneric)
            {
                return new GenericTypeRef(span, tref, qname.GenericParams.Select(p => FromObject(Span2.Invalid, p)).ToList());
            }
            else
            {
                return tref;
        ...
        internal static TypeRef FromObject(Span2 span, object obj)
        {
        ...
        public static TypeRef FromString(Span2 span, string name, NamingContext naming = null)
        {
            ...
            if (sepindex >= 0)
            {
                ...
                {
                    var str = names[i];
                    trefs[i] = FromString(new Span2(span.Start + offset, str.Length), str, naming);
            ...
            if (name[0] == '?')
            {
                return new NullableTypeRef(span, FromString(new Span2(span.Start + 1, span.Length - 1), name.Substring(1), naming));
            }
    ...
    public sealed class PrimitiveTypeRef : TypeRef
    {
        ...
        public PrimitiveTypeRef(Span2 span, PrimitiveType name)
            : base(span)
        {
    ...
    public sealed class ReservedTypeRef : TypeRef
    {
        ...
        public ReservedTypeRef(Span2 span, ReservedType type)
            : base(span)
        {
    ...
    public sealed class ClassTypeRef : TypeRef, IEquatable<ClassTypeRef>, INamedTypeRef
    {
        ...
        public ClassTypeRef(Span2 span, QualifiedName className)
            : base(span)
        {
    ...
    public sealed class TranslatedTypeRef : TypeRef, IEquatable<TranslatedTypeRef>, INamedTypeRef
    {
        ...
        public TranslatedTypeRef(Span2 span, QualifiedName className, TypeRef originalType)
            : base(span)
        {
    ...
    public sealed class IndirectTypeRef : TypeRef
    {
        ...
        public IndirectTypeRef(Span2 span, Expression/*!*/ classNameVar)
            : base(span)
        {
    ...
    public sealed class NullableTypeRef : TypeRef
    {
        ...
        public NullableTypeRef(Span2 span, TypeRef/*!*/ targetType)
            : base(span)
        {
    ...
    public sealed class MultipleTypeRef : TypeRef
    {
        ...
        public MultipleTypeRef(Span2 span, IList<TypeRef>/*!*/ multipleTypes)
            : base(span)
        {
    ...
    public sealed class GenericTypeRef : TypeRef
    {
        ...
        public GenericTypeRef(Span2 span, TypeRef targetType, List<TypeRef> genericParams)
            : base(span)
        {
    ...
    public sealed class AnonymousTypeRef : TypeRef
    {
        ...
        public AnonymousTypeRef(Span2 span, AnonymousTypeDecl typeDeclaration)
            : base(span)
        {
