...
namespace Devsense.PHP.Syntax.Ast
{
    ...
    public sealed class JumpStmt : Statement
	{
		...
		public JumpStmt(Text.Span2 span, Types type, Expression expr)
			: base(span)
		{
			this.type = type;
			this.expr = expr;
    ...
    public sealed class GotoStmt : Statement
	{
		...
		public GotoStmt(Text.Span2 span, VariableNameRef/*!*/labelName)
			: base(span)
		{
    ...
    public sealed class LabelStmt : Statement
	{
		...
		public LabelStmt(Text.Span2 span, VariableNameRef/*!*/name)
			: base(span)
		{
