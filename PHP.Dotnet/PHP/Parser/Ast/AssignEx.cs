...
namespace Devsense.PHP.Syntax.Ast
{
    ...
    public abstract class AssignEx : Expression
    {
        ...
        protected AssignEx(Text.Span2 p) : base(p) { }
    }
    ...
    public sealed class ValueAssignEx : AssignEx
    {
        ...
        public ValueAssignEx(Text.Span2 span, Operations operation, VarLikeConstructUse/*!*/ lvalue, Expression/*!*/ rvalue)
            : base(span)
        {
            this.lvalue = lvalue;
            this.rvalue = rvalue;
    ...
    public sealed class RefAssignEx : AssignEx
    {
        ...
        public RefAssignEx(Text.Span2 span, VarLikeConstructUse/*!*/ lvalue, Expression/*!*/ rvalue)
            : base(span)
        {
