...
namespace Devsense.PHP.Syntax.Ast
{
    ...
    public sealed class BinaryEx : Expression, IBinaryExpression
    {
        ...
        public Span2 OperatorSpan => SpanUtils.SpanIntermission(leftExpr.Span, rightExpr.Span);
        ...
        public BinaryEx(Text.Span2 span, Operations operation, Expression/*!*/ leftExpr, Expression/*!*/ rightExpr)
            : base(span)
        {
