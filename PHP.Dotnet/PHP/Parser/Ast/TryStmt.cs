...
namespace Devsense.PHP.Syntax.Ast
{
    ...
    public sealed class TryStmt : Statement
    {
        ...
        public TryStmt(Text.Span2 p, BlockStmt/*!*/ body, IList<CatchItem> catches, FinallyItem finallyItem)
            : base(p)
        {
    ...
    public sealed class CatchItem : LangElement
    {
        ...
        public CatchItem(Text.Span2 p, TypeRef tref, DirectVarUse/*!*/ variable,
            BlockStmt body)
            : base(p)
        {
    ...
    public sealed class FinallyItem : LangElement
    {
        ...
        public FinallyItem(Text.Span2 span, BlockStmt body)
            : base(span)
        {
            this.body = body;
        }
    ...
    public sealed class ThrowStmt : Statement
    {
        ...
        public ThrowStmt(Text.Span2 span, Expression/*!*/ expression)
            : base(span)
        {
