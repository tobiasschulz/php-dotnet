...
namespace Devsense.PHP.Syntax.Ast
{
    ...
    {
		public ConstantUse(Text.Span2 span)
			: base(span)
		{
		}
	}
    ...
    public sealed class GlobalConstUse : ConstantUse
	{
        ...
        public GlobalConstUse(Text.Span2 span, TranslatedQualifiedName name)
			: base(span)
		{
			this._fullName = name;
		}
    ...
    public class ClassConstUse : ConstantUse
	{
        ...
        /// </summary>
        public Text.Span2 NamePosition => name.Span;

        public ClassConstUse(Text.Span2 span, TypeRef/*!*/typeRef, VariableNameRef/*!*/ name)
            : base(span)
        {
    ...
    public sealed class PseudoClassConstUse : ClassConstUse
    {
        ...
        internal PseudoClassConstUse(Text.Span2 span, GenericQualifiedName className, Text.Span2 classNamePosition, Types type, Text.Span2 namePosition)
            : this(span, ClassTypeRef.FromGenericQualifiedName(classNamePosition, className), type, namePosition)
		{
		}

        public PseudoClassConstUse(Text.Span2 span, TypeRef/*!*/typeRef, Types type, Text.Span2 namePosition)
    ...
    public sealed class PseudoConstUse : Expression
	{
		...
		public PseudoConstUse(Text.Span2 span, Types type)
			: base(span)
		{
			this.type = type;
		}
