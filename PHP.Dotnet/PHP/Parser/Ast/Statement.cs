...
namespace Devsense.PHP.Syntax.Ast
{
    ...
    {
        protected Statement(Text.Span2 span)
            : base(span)
        {
        }
    ...
    public class BlockStmt : Statement, IBlockStatement
    {
        ...
        public BlockStmt(Text.Span2 span, IList<Statement>/*!*/body)
            : base(span)
        {
        ...
        internal void ExtendSpan(Text.Span2 newSpan)
        {
    ...
    internal class SimpleBlockStmt : BlockStmt
    {
        ...
        public SimpleBlockStmt(Span2 span, IList<Statement> body) : base(span, body)
        {
        }
    }
    ...
    internal class ColonBlockStmt : BlockStmt
    {
        ...
        public ColonBlockStmt(Span2 span, IList<Statement> body, Tokens closingToken) : base(span, body)
        {
            Debug.Assert(
    ...
    public sealed class ExpressionStmt : Statement, IExpressionStatement
    {
        ...
        public ExpressionStmt(Text.Span2 span, Expression/*!*/ expression)
            : base(span)
        {
    ...
    public sealed class EmptyStmt : Statement
    {
        ...
        public EmptyStmt(Text.Span2 p) : base(p) { }
    ...
    public sealed class UnsetStmt : Statement
    {
        ...
        public UnsetStmt(Text.Span2 p, IList<VariableUse>/*!*/ varList)
            : base(p)
        {
    ...
    public sealed class GlobalStmt : Statement
    {
        ...
        public GlobalStmt(Text.Span2 p, IList<SimpleVarUse>/*!*/ varList)
            : base(p)
        {
            Debug.Assert(varList != null);
    ...
    public sealed class StaticStmt : Statement
    {
        ...
        public StaticStmt(Text.Span2 p, IList<StaticVarDecl>/*!*/ stVarList)
            : base(p)
        {
    ...
    public class StaticVarDecl : LangElement
    {
        ...
        /// </summary>
        public Text.Span2 NameSpan => new Text.Span2(Span.Start, variable.Value.Length + 1);
        ...
        public StaticVarDecl(Text.Span2 span, VariableName variableName, Expression initializer)
            : base(span)
        {
    ...
    public sealed class DeclareStmt : Statement
    {
        ...
        public DeclareStmt(Text.Span2 p, GlobalConstantDecl[]/*!*/declarations, Statement/*!*/statement)
            : base(p)
        {
    ...
    public abstract class UseBase
    {
        ...
        /// Use position.
        /// </summary>
        public Span2 Span => _span;
        private readonly Span2 _span;

        /// <summary>
        /// Create new use.
        /// </summary>
        /// <param name="span">Entire span.</param>
        public UseBase(Span2 span)
        {
    ...
    public sealed class SimpleUse : UseBase
    {
        ...
        /// can be <c>invalid</c>.
        /// </summary>
        public Span2 AliasSpan => _aliasSpan;
        private readonly Span2 _aliasSpan;

        /// <summary>
        /// Span of associated qualified name.
        /// </summary>
        public Span2 NameSpan => _nameSpan;
        private readonly Span2 _nameSpan;
        ...
        public SimpleUse(Span2 span, Span2 aliasSpan, Span2 qnameSpan, Alias alias, QualifiedName qualifiedName)
            : base(span)
        {
    ...
    public sealed class GroupUse : UseBase
    {
        ...
        public GroupUse(Span2 span, QualifiedNameRef prefix, IList<SimpleUse> uses)
            : base(span)
        {
            Debug.Assert(span.IsValid);
    ...
    public class UseStatement : Statement
    {
        ...
        public UseStatement(Span2 span, IList<UseBase> uses, AliasKind kind)
            : base(span)
        {
            Debug.Assert(uses != null);
