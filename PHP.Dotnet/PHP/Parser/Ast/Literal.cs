...
namespace Devsense.PHP.Syntax.Ast
{
	...
	public abstract class Literal : Expression
	{
        ...
        protected Literal(Text.Span2 span)
			: base(span)
		{
		}
        ...
        public static Literal Create(Text.Span2 span, object value)
        {
 ...
 //       }
    ...
    public sealed class LongIntLiteral : Literal
	{
		...
		/// Initializes a new instance of the IntLiteral class.
		/// </summary>
		public LongIntLiteral(Text.Span2 span, long value)
			: base(span)
		{
			this.value = value;
        }
    ...
    public sealed class DoubleLiteral : Literal
    {
        ...
        public DoubleLiteral(Text.Span2 p, double value)
			: base(p)
		{
			this.value = value;
        }
    ...
    public sealed class StringLiteral : Literal
    {
		...
		/// </summary>
		public StringLiteral(Text.Span2 span, string value)
			: base(span)
		{
			this.value = value;
        }
    ...
    public sealed class BinaryStringLiteral : Literal
	{
		...
		/// Initializes a new instance of the StringLiteral class.
		/// </summary>
		public BinaryStringLiteral(Text.Span2 span, byte[]/*!*/ value)
			: base(span)
		{
			this.value = value;
		}
    ...
    public sealed class BoolLiteral : Literal
	{
		...
		public BoolLiteral(Text.Span2 span, bool value)
			: base(span)
		{
			this.value = value;
		}
    ...
    public sealed class NullLiteral : Literal
	{
		...
		public NullLiteral(Text.Span2 span)
			: base(span)
		{
		}
