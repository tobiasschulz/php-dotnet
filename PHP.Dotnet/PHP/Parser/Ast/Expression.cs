...
namespace Devsense.PHP.Syntax.Ast
{
    ...
    public abstract class Expression : LangElement, IExpression
    {
        ...
        protected Expression(Text.Span2 span) : base(span) { }
    ...
    public abstract class ConstantDecl : LangElement
    {
        ...
        public ConstantDecl(Text.Span2 span, string/*!*/ name, Text.Span2 namePos, Expression/*!*/ initializer)
            : base(span)
        {
    ...
    public abstract class VarLikeConstructUse : Expression
    {
        ...
        protected VarLikeConstructUse(Text.Span2 p) : base(p) { }
    }
    ...
    public abstract class EncapsedExpression : Expression
    {
        ...
        public sealed class ParenthesisExpression : EncapsedExpression
        {
            ...
            public ParenthesisExpression(Span2 span, Expression expression) : base(span, expression)
            {
        ...
        public sealed class BracesExpression : EncapsedExpression
        {
            ...
            public BracesExpression(Span2 span, Expression expression) : base(span, expression)
            {
                _expression = expression;
            }
        }
        ...
        public sealed class DollarBracesExpression : EncapsedExpression
        {
            ...
            public DollarBracesExpression(Span2 span, Expression expression) : base(span, expression)
            {
                _expression = expression;
            }
        }
        ...
        public abstract class StringEncapsedExpression : EncapsedExpression
        {
            ...
            public StringEncapsedExpression(Span2 span, Expression expression) : base(span, expression) { }
        }
        ...
        public sealed class SingleQuotedExpression : StringEncapsedExpression
        {
            ...
            public SingleQuotedExpression(Span2 span, Expression expression) : base(span, expression)
            {
                _expression = expression;
            }
        }
        ...
        public sealed class DoubleQuotedExpression : StringEncapsedExpression
        {
            ...
            public DoubleQuotedExpression(Span2 span, Expression expression) : base(span, expression)
            {
                _expression = expression;
            }
        }
        ...
        public sealed class BackQuotedExpression : StringEncapsedExpression
        {
            ...
            public BackQuotedExpression(Span2 span, Expression expression) : base(span, expression)
            {
                _expression = expression;
            }
        }
        ...
        public sealed class NowDocExpression : StringEncapsedExpression
        {
            ...
            public NowDocExpression(Span2 span, Expression expression, string label)
        ...
        public sealed class HereDocExpression : StringEncapsedExpression
        {
            ...
            public HereDocExpression(Span2 span, Expression expression, string label, bool quoted)
                : base(span, expression)
            {
                _expression = expression;
                _label = label;
        ...
        public EncapsedExpression(Span2 span, Expression expression) : base(span)
        {
