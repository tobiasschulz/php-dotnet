...
namespace Devsense.PHP.Syntax.Ast
{
	...
	public sealed class ItemUse : CompoundVarUse
    {
        ...
        public ItemUse(Text.Span2 p, Expression/*!*/ array, Expression index, bool functionArrayDereferencing = false, bool isBraces = false)
            : base(p)
        {
    ...
    public sealed class StringLiteralDereferenceEx : Expression
    {
        ...
        public StringLiteralDereferenceEx(Text.Span2 span, Expression expr, Expression key)
            : base(span)
        {
