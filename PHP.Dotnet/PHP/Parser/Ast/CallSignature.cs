...
namespace Devsense.PHP.Syntax.Ast
{
    ...
    public sealed class ActualParam : LangElement
    {
        ...
        public ActualParam(Text.Span2 p, Expression param)
            : this(p, param, Flags.Default)
        { }

        public ActualParam(Text.Span2 p, Expression param, Flags flags)
            : base(p)
        {
    ...
    public sealed class NamedActualParam : LangElement
    {
        ...
        public NamedActualParam(Text.Span2 span, string name, Expression/*!*/ expression)
            : base(span)
        {
    ...
    public sealed class CallSignature : AstNode
    {
        ...
        /// </summary>
        public Text.Span2 Position { get { return _position; } set { _position = value; } }
        private Text.Span2 _position;
        ...
        public CallSignature(IList<ActualParam> parameters, Text.Span2 position)
        ...
        /// <param name="position">Signature position.</param>
        public CallSignature(IList<ActualParam> parameters, IList<TypeRef> genericParams, Text.Span2 position)
        {
