...
namespace Devsense.PHP.Syntax.Ast
{
    ...
    public sealed class GlobalCode : LangElement, IGlobalCode
    {
        ...
        /// </summary>
        public GlobalCode(Text.Span2 span, IList<Statement>/*!*/ statements, SourceUnit/*!*/ sourceUnit) : base(span)
        {
    ...
    public sealed class NamespaceDecl : Statement
    {
        ...
        public NamespaceDecl(Text.Span2 p)
            : this(p, QualifiedNameRef.Invalid, false)
        {
            this.isAnonymous = true;
            this.qualifiedName = new QualifiedNameRef(Text.Span2.Invalid, Name.EmptyBaseName, Name.EmptyNames);
            this.IsSimpleSyntax = false;
        }

        public NamespaceDecl(Text.Span2 p, QualifiedNameRef name, bool simpleSyntax)
            : base(p)
        {
        ...
        /// </summary>
        /// <param name="p"></param>
        internal void UpdatePosition(Text.Span2 p)
        {
            this.Span = p;
        }
    ...
    public sealed class GlobalConstDeclList : Statement
    {
        ...
        /// </summary>
        public Text.Span2 EntireDeclarationSpan
        {
            get { return this.Span; }
        }

        public GlobalConstDeclList(Text.Span2 span, IList<GlobalConstantDecl>/*!*/ constants)
            : base(span)
        {
    ...
    public sealed class GlobalConstantDecl : ConstantDecl
    {
        ...
        public GlobalConstantDecl(Text.Span2 span, bool isConditional,
            string/*!*/ name, Text.Span2 namePos, Expression/*!*/ initializer)
