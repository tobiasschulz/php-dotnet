...
namespace Devsense.PHP.Syntax.Ast
{
    ...
    public abstract class StaticFieldUse : VariableUse
    {
        ...
        internal StaticFieldUse(Span2 span, GenericQualifiedName typeName, Span2 typeNamePosition)
            : this(span, TypeRef.FromGenericQualifiedName(typeNamePosition, typeName))
        {
        }

        public StaticFieldUse(Span2 span, TypeRef typeRef)
            : base(span)
        {
    ...
    public sealed class DirectStFldUse : StaticFieldUse
    {
        ...
        /// </summary>
        public override Span2 NameSpan => propertyName.Span;

        public DirectStFldUse(Span2 span, TypeRef typeRef, VariableName propertyName, Span2 propertyNamePosition)
            : base(span, typeRef)
        {
            this.propertyName = new VariableNameRef(propertyNamePosition, propertyName);
        }

        internal DirectStFldUse(Text.Span2 span, GenericQualifiedName qualifiedName, Span2 qualifiedNameSpan, VariableName propertyName, Span2 propertyNameSpan)
    ...
    public sealed class IndirectStFldUse : StaticFieldUse
    {
        ...
        public override Span2 NameSpan => fieldNameExpr.Span;

        public IndirectStFldUse(Text.Span2 span, TypeRef typeRef, Expression/*!*/ fieldNameExpr)
            : base(span, typeRef)
        {
