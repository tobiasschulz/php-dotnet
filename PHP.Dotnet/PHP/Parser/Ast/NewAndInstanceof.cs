...
namespace Devsense.PHP.Syntax.Ast
{
    ...
    public sealed class NewEx : VarLikeConstructUse
    {
        ...
        public NewEx(Text.Span2 span, TypeRef/*!*/ classNameRef, IList<ActualParam>/*!*/ parameters, Text.Span2 parametersSpan)
            : base(span)
        {
    ...
    public sealed class InstanceOfEx : Expression
    {
        ...
        public InstanceOfEx(Text.Span2 span, Expression/*!*/ expression, TypeRef/*!*/ classNameRef)
            : base(span)
        {
    ...
    public sealed class TypeOfEx : Expression
    {
        ...
        public TypeOfEx(Text.Span2 span, TypeRef/*!*/ classNameRef)
            : base(span)
        {
