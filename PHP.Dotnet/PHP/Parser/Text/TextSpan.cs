...
namespace Devsense.PHP.Text
{
    ...
    public struct TextSpan : IEquatable<TextSpan>
    {
        ...
        public TextSpan(ILineBreaks lineBreaks, Span2 span)
		{
			if (lineBreaks == null)
        ...
        public Span2 Span { get { return new Span2(_start.Position, _length); } }
        ...
        public static implicit operator Span2(TextSpan span)
		{
			return span.Span;
		}
        ...
        public TextSpan? Overlap(Span2 span)
		{
            Span2? overlap = this.Span.Overlap(span);
            if (overlap.HasValue)
        ...
        public TextSpan? Intersection(Span2 span)
		{
            Span2? intersection = this.Span.Intersection(span);
