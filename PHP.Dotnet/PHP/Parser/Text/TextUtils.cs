...
namespace Devsense.PHP.Text
{
    ...
    public static class TextUtils
    {
        ...
        /// <summary>
        /// Gets <see cref="Span2"/> of whole <paramref name="line"/>.
        /// </summary>
        /// <param name="lineBreaks">Information about line breaks in the document. Cannot be <c>null</c>.</param>
        /// <param name="line">Line number.</param>
        /// <returns><see cref="Span2"/> of line specified by parameter <paramref name="line"/> within the document <paramref name="lineBreaks"/>.</returns>
        public static Span2 GetLineSpan(this ILineBreaks/*!*/lineBreaks, int line)
        {
            if (lineBreaks == null)
            ...
            return Span2.FromBounds(start, end);
        }
